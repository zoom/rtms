...
namespace rtms {
    ...
    using SessionUpdateFn = function<void( int, session_info* session)> ;
    using UserUpdateFn = function<void( int, participant_info* pi)> ;
    using AudioDataFn = function<void( unsigned char*, int, unsigned int, rtms_metadata*)> ;
    using VideoDataFn = function<void( unsigned char*, int, unsigned int, const char*, rtms_metadata*)> ;
    using TranscriptDataFn = function<void( unsigned char*, int, unsigned int, rtms_metadata*)> ;
